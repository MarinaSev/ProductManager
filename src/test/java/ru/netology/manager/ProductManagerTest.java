...
class ProductManagerTest {
    ...
    private Book third = new Book(89, "Galaxy A10", 500, "Peter York");
    private Book fifth = new Book(90, "Без очереди", 430, "Евгения Некрасова");
    private Book sixth = new Book(91, "Samsung", 500, "Peter York");
    private Book eighth = new Book(92, "Дом в котором", 800, "Мариам Петросян");
    ...
    public void shouldSearchByAuthorIfOne() {
        ...
        Product[] actual = manager.searchBy("Мариам Петросян");
